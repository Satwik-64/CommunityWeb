...
<body>
    ...
    <section>
        ...
        <div class="button-container">
            ...
            <button onclick="window.location.href='view_donated_items.php'">Take Items</button>
            ...
            <button onclick="window.location.href='my_donated_items.php'">My Donations</button>
        </div>
    </section>
</body>
</html>
